...
const Topbar = ({ themeMode, themeToggler, onSidebarOpen, pages, className, ...rest }) => {
  ...
  return (
    <Toolbar disableGutters className={classes.toolbar} {...rest}>
      <div             style={{height:"90px", paddingBottom:"15px"}}
className={classes.logoContainer}>
        <a href="/" title="drywallmagana">
          <Image
            style={{height:"100%", width:"120%", padding:"5px"}}
            src={themeMode === 'light' ? 'images/logoclean.png' : 'images/logoclean.png'}
            alt="drywallmagana"
            lazy={false}
          />
        </a>
