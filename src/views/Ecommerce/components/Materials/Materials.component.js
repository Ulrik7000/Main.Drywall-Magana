...
const [isClick, setClick] = useState(false);
  ...
  const rating = count => {
    ...
    <div className={className} {...rest}>
      <SectionHeader
        title="Drywall finishing materials"
        subtitle="This is our cherry-picked list of trust worthy materials constantly tested by drywall magana in the most demanding projects. If you want your project to run as smooth as possible, We recommend you to take a look at this list of materials available for you to purchase ( click the buy now button to enter the home depot listing and complete the checkout on their end, Drywall Magana.Ltd does not guarantee availability, price or delivery of the product chosen, nor take responsability on the final checkout resolution between client and merchant )"
        data-aos="fade-up"
      />
