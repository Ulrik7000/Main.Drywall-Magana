  ...
  return (
    <div className={className} {...rest}>
      <SectionHeader
        ...
        subtitle="This is our cherry-picked list of top quality hand taping tools to finish your project the smoothest way. If you want to do your drywall finishing on your own, old school style, we recommend you to take a look at this list of hand taping tools. ( click the buy now button to enter the CSR building supplies listing and complete the checkout on their end, Drywall Magana.Ltd does not guarantee availability, price or delivery of the product chosen, nor take responsability on the final checkout resolution between client and merchant )"
        data-aos="fade-up"
      />
