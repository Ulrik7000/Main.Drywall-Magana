export const popularNews = [
  ...
  },
  {
    ...
    date: '04 Aug',
    tags: ['adidas', 'sport', 'store', 'training'],
  },
];
...
export const featuredArticles = [
  {
    ...
    subtitle:
      'Be Your Best Every Time With Nike Shoes And Clothing. store Online. The Official Website. Home Of Everything Nike. store The Latest Releases Today! Types: Shoes, Tops.',
    author: {
      photo: {
    ...
    date: '04 Aug',
    tags: ['nike', 'sport', 'store', 'training'],
  },
  {
    cover: {
    ...
    date: '04 Aug',
    tags: ['larq', 'bottle', 'store', 'drinks', 'eco', 'self washing'],
  },
];
